...
Процедура ПереопределитьРазделыДанных(РазделыДанных) Экспорт
	...
	Для Каждого РазделДанных Из РазделыДанных Цикл
		РазделПоИдентификатору = СинхронизацияДанныхЗарплатаКадрыСервер.РазделДанныхПоИдентификатору(РазделДанных);
...
Процедура ДополнитьКэшПоОбъекту(Кэш, Объект, ИмяПланаОбмена, ИменаРеквизитов = Неопределено)
	...
	ОтсутствуютВКэше = ДанныеОтстутсвующиеВКэше(Кэш, Объект, ИмяГоловнаяОрганизация, ИмяФизическоеЛицо);
...
Функция ДанныеОтстутсвующиеВКэше(Кэш, Знач Объект, ИмяГоловнаяОрганизация, ИмяФизическоеЛицо)
