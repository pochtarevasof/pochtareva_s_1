...
Процедура ПриЗаписиСправочникаФизическиеЛица(ФизическоеЛицоОбъект, Отказ) Экспорт
	...
	РегистрыСведений.ОчередьОбработкиКадровыхДанныхФСС.ЗапланироватьОбновлениеПоФизическомуЛицу(ФизическоеЛицо);
КонецПроцедуры
...
Процедура ПриЗаписиРегистраГражданствоФизическихЛиц(РегистрСведенийНаборЗаписей, Отказ, Замещение) Экспорт
	...
	Для Каждого Запись Из РегистрСведенийНаборЗаписей Цикл
		Если ОбработанныеФизическиеЛица.Найти(Запись.ФизическоеЛицо) = Неопределено Тогда
			ОбработанныеФизическиеЛица.Добавить(Запись.ФизическоеЛицо);
			РегистрыСведений.ОчередьОбработкиКадровыхДанныхФСС.ЗапланироватьОбновлениеПоФизическомуЛицу(Запись.ФизическоеЛицо);
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
Процедура ПриЗаписиРегистраДокументыФизическихЛиц(РегистрСведенийНаборЗаписей, Отказ, Замещение) Экспорт
	...
	ОбработанныеФизическиеЛица = Новый Массив;
	Для Каждого Запись Из РегистрСведенийНаборЗаписей Цикл
		Если ОбработанныеФизическиеЛица.Найти(Запись.Физлицо) = Неопределено Тогда
			ОбработанныеФизическиеЛица.Добавить(Запись.Физлицо);
			РегистрыСведений.ОчередьОбработкиКадровыхДанныхФСС.ЗапланироватьОбновлениеПоФизическомуЛицу(Запись.Физлицо);
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
