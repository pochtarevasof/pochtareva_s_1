...
Функция ШтампВремени(АдресСервиса, ХешДанных64ШестнадцатеричныхСимвола, Случайные16ШестнадцатеричныхСимволов) Экспорт
...
Функция ПрочитатьСвойстваБлока(ЧтениеДанных, РазмерДанных, ЗаписьДанных = Неопределено)
