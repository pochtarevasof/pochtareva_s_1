...
// См. метод ПодобратьСписокФизЛиц.
Функция НайтиОднофамильцев(ФизическоеЛицоСсылка, Знач Фамилия, Знач Имя, Знач Отчество, Знач Уточнение = Неопределено) Экспорт
	Возврат ПодобратьСписокФизЛиц(ФизическоеЛицоСсылка, Фамилия, Имя, Отчество, Уточнение);
КонецФункции
