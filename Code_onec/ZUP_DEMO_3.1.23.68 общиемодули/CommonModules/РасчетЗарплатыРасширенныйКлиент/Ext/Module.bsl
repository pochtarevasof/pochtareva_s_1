 	...
 	Если УдалениеСторно Тогда
		...
		Если Форма[ИмяРеквизита] Тогда
			...
			ПоказатьВопрос(ОписаниеОповещения,
				НСтр("ru = 'Вы уверены, что хотите удалить сторнирующую строку?'"), РежимДиалогаВопрос.ДаНет,, КодВозвратаДиалога.Нет);
		Иначе
			ПоказатьПредупреждение(, НСтр("ru = 'Удаление сторнирующих строк не рекомендуется!
